   ...
   <div class="container">
     <div class="row align-items-center">
       ...
       <div class="col-lg-4 text-lg-start mt-4 mt-lg-0">
         <p class="fs--1 text-uppercase ls fw-bold mb-0">www.monkeycoder.cl</p>
       </div>
       <div class="col-lg-4 text-lg-end order-lg-2 mt-2 mt-lg-0">
         <p class="fs--1 text-uppercase ls fw-bold mb-0">Este sitio fue hecho por un &#128018; con mucho <span class="text-danger fas fa-heart mx-1"></span>by <a class="text-600" href="https://www.monkeycoder.cl/">monkeycoder</a></p>
       </div>
     </div>
   </div>
 </footer>
